...
- [**Pre-execute hooks**](/docs/protocol/hooks/pre-execute): Run **before** an action is handled. They may inspect and optionally mutate the message envelope.
- [**Post-execute hooks**](/docs/protocol/hooks/post-execute): Run **after** an action is processed. They are used for logging, analytics, or other external integrations.
...
Learn more:
- [Hook History](/docs/protocol/hooks/history)
- [Hook Runs Database](/docs/protocol/hooks/runs)

## Execution Contract

All hook types must conform to the standardized [Execution Contract](/docs/protocol/hooks/contract), which defines:
