...
- [**Pre-execute hooks**](pre-execute): Run **before** an action is handled. They may inspect and optionally mutate the message envelope.
- [**Post-execute hooks**](post-execute): Run **after** an action is processed. They are used for logging, analytics, or other external integrations.
