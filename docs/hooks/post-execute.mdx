...
There is also an existing [hooks registry](/docs/protocol/hooks/registry) that allows users to discover and
...
[Execution Contract](/docs/protocol/hooks/contract). The only exception is their ability to perform outbound network
