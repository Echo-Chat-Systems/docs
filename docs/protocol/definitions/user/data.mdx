...
a user may be represented in a **profile** or as a **private-user** with full internal data.

Additionally, [user certificates](/docs/protocol/definitions/user/certificates) are used for any communication beyond
...
<ParamsList>
    ...
    <Param name="settings" type="string (b64)" required>
