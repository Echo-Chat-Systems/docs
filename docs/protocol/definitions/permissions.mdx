...
| Permission      | Bit Number | Bit Position (HEX) | Description                                                                                 | Text ID               |
|-----------------|------------|--------------------|---------------------------------------------------------------------------------------------|-----------------------|
...
| Delete Invites  | 15         | 0000 8000          | Allows the user to delete active guild invites                                              | guild:invites:delete  |
| Manage Invites  | 14         | 0000 4000          | Allows the user to manage active guild invites                                              | guild:invites:manage  |
| Delete Emojis   | 13         | 0000 2000          | Allows the user to delete emojis                                                            | guild:emojis:delete   |
| Create Emojis   | 12         | 0000 1000          | Allows the user to create emojis                                                            | guild:emojis:create   |
| Manage Emojis   | 11         | 0000 0800          | Allows the user to manage emoji names (not images)                                          | guild:emojis:manage   |
| Delete Stickers | 10         | 0000 0400          | Allows the user to delete stickers                                                          | guild:stickers:delete |
| Create Stickers | 9          | 0000 0200          | Allows the user to create stickers                                                          | guild:stickers:create |
| Manage Stickers | 8          | 0000 0100          | Allows the user to manage sticker names (not images)                                        | guild:stickers:manage |
| Not Used        | 7          | 0000 0080          | Not used                                                                                    | Not used              |
| Not Used        | 6          | 0000 0040          | Not used                                                                                    | Not used              |
| Not Used        | 5          | 0000 0020          | Not Used                                                                                    | Not Used              |
| Not Used        | 4          | 0000 0010          | Not Used                                                                                    | Not Used              |
| Not Used        | 3          | 0000 0008          | Not Used                                                                                    | Not Used              |
...
| Not Used              | 28-8       | 1FFF FF00          | Not used                                                | Not used             |
| Stream Screen         | 7          | 0000 0040          | Allows the user to stream their screen in the channel   | voice:stream         |
