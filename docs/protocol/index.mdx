...
use REST. These endpoints are documented in the [REST API section](/protocol/rest/index).
...
| Target                                         | Description                              |
|------------------------------------------------|------------------------------------------|
| [`auth`](/protocol/targets/auth/index)         | Authentication and session handling.     |
| [`users`](/protocol/targets/users/index)       | Profile access, updates, and reputation. |
| [`social`](/protocol/targets/social/index)     |                                          |
| [`guilds`](/protocol/targets/guilds/index)     | Guild (server) creation and management.  |
| [`channels`](/protocol/targets/channels/index) | Channel creation, updates, and listing.  |
| [`messages`](/protocol/targets/messages/index) | Messaging actions including reactions.   |
| [`invites`](/protocol/targets/invites/index)   | Guild invite management.                 |
| [`postie`](/protocol/targets/postie/index)     | Pub/sub channel and state updates.       |
| [`admin`](/protocol/targets/admin/index)       | Reserved for administrative features.    |
