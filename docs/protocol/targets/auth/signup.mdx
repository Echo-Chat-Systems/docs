...
<ParamsList>
    ...
    <Param name="profile" type="object" required>
        User public facing [`profile`](/docs/protocol/definitions/users/data.mdx#profile-structure)
    </Param>
</ParamsList>
...
<ParamsList>
    <Param name="user" type="object" required>
        Private [user data](/docs/protocol/definitions/users/data.mdx#private-user-structure)
    </Param>
</ParamsList>
