...
| `not-found`         | Failed to find the requested resource.                            | Something relating to the client message was not found/does not exist |
...
<ParamsList>
    <Param name="message" type="string" required>A human-readable error message string explaining what went wrong</Param>
