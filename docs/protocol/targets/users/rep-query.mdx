...
<ParamsList>
    <Param body="users" type="object" required>
        Flat object containing [User Ids](/docs/protocol/definitions/users/identity) as keys and
        [Remark](/docs/protocol/definitions/users/reputation#remark-structure) as values.
    </Param>
</ParamsList>
