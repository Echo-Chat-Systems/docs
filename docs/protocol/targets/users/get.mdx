...
Retrieves a [**public user**](/docs/protocol/definitions/users/data.mdx#public-user-structure) by their user ID (Ed25519 public key). This action does not require authentication and returns only non-sensitive information.
...
<ParamsList>
    <Param name="id" type="string" required>
        [User](/docs/protocol/definitions/users/identity.mdx) id.
    </Param>
</ParamsList>
...
<ParamsList>
    <Param name="user" type="object" required>
        [Public User](/docs/protocol/definitions/users/data.mdx#public-user-structure) requested.
    </Param>
</ParamsList>
