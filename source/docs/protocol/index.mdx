...
<Tabs>
    ...
    <TabItem value="schema" label="Schema">
        <Schema path="/comms/basic-message.json">
...
use REST. These endpoints are documented in the [REST API section](/protocol/rest/index.mdx).
...
| Target                                             | Description                              |
|----------------------------------------------------|------------------------------------------|
| [`auth`](/protocol/targets/auth/index.mdx)         | Authentication and session handling.     |
| [`users`](/protocol/targets/users/index.mdx)       | Profile access, updates, and reputation. |
| [`social`](/protocol/targets/social/index.mdx)     |                                          |
| [`guilds`](/protocol/targets/guilds/index.mdx)     | Guild (server) creation and management.  |
| [`channels`](/protocol/targets/channels/index.mdx) | Channel creation, updates, and listing.  |
| [`messages`](/protocol/targets/messages/index.mdx) | Messaging actions including reactions.   |
| [`invites`](/protocol/targets/invites/index.mdx)   | Guild invite management.                 |
| [`postie`](/protocol/targets/postie/index.mdx)     | Pub/sub channel and state updates.       |
| [`admin`](/protocol/targets/admin/index.mdx)       | Reserved for administrative features.    |
