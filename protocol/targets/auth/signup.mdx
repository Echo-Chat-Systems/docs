...
<ParamField body="keys" type="object" required>
    User-generated public [keypair](/protocol/definitions/crypto/keys#pubkeys)
</ParamField>
<ParamField body="profile" type="object" required>
    User public facing [`profile`](/protocol/definitions/users/data#profile-structure)
</ParamField>
...
<ParamField body="user" type="object" required>
    Private [user data](/protocol/definitions/users/data#private-user-structure)
</ParamField>
