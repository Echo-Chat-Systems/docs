...
See [User Data](/protocol/definitions/users/data) for contents of `user` object.
...
<Danger>If at any point the signin fails, the server will return one of the following [Error Messages](/protocol/targets/error)</Danger>
