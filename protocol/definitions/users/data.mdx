...
| `keys`    | User public keys              | [`pubkeys`](/protocol/definitions/crypto/keys#pubkeys)     |
| `profile` | User profile                  | [`profile`](#profile-structure)                            |
| `rep`     | User public reputation record | [`rep`](/protocol/definitions/users/reputation#rep-object) |
